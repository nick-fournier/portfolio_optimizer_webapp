from webface.models import Financials, BalanceSheet, Scores
...
class GetFscore:
    ...
    def calc_scores(self):
        ...
        for x in self.data.security_id.unique():
            ...
            measures['pe_ratio'] = df['quarterly_close'] / df['eps']
            df_measures = df_measures.append(measures)

        # Fill Nones
        df_measures = df_measures.fillna(np.nan)
        df_measures['PF_score'], df_measures['PF_score_weighted'] = df_measures.apply(PF_score, axis=1)
