...
class Financials(models.Model):
    security_id = models.ForeignKey(SecurityMeta, on_delete=models.CASCADE)
    date = models.DateField()
    research_development = models.DecimalField(max_digits=15, decimal_places=2)
    effect_of_accounting_charges = models.DecimalField(max_digits=15, decimal_places=2)
    income_before_tax = models.DecimalField(max_digits=15, decimal_places=2)
    minority_interest = models.DecimalField(max_digits=15, decimal_places=2)
    net_income = models.DecimalField(max_digits=15, decimal_places=2)
    selling_general_administrative = models.DecimalField(max_digits=15, decimal_places=2)
    gross_profit = models.DecimalField(max_digits=15, decimal_places=2)
    ebit = models.DecimalField(max_digits=15, decimal_places=2)
    operating_income = models.DecimalField(max_digits=15, decimal_places=2)
    other_operating_expenses = models.DecimalField(max_digits=15, decimal_places=2)
    interest_expense = models.DecimalField(max_digits=15, decimal_places=2)
    extraordinary_items = models.DecimalField(max_digits=15, decimal_places=2)
    non_recurring = models.DecimalField(max_digits=15, decimal_places=2)
    other_items = models.DecimalField(max_digits=15, decimal_places=2)
    income_tax_expense = models.DecimalField(max_digits=15, decimal_places=2)
    total_revenue = models.DecimalField(max_digits=15, decimal_places=2)
    total_operating_expenses = models.DecimalField(max_digits=15, decimal_places=2)
    cost_of_revenue = models.DecimalField(max_digits=15, decimal_places=2)
    total_other_income_expense_net = models.DecimalField(max_digits=15, decimal_places=2)
    discontinued_operations = models.DecimalField(max_digits=15, decimal_places=2)
    net_income_from_continuing_ops = models.DecimalField(max_digits=15, decimal_places=2)
    net_income_applicable_to_common_shares = models.DecimalField(max_digits=15, decimal_places=2)

class BalanceSheet(models.Model):
    security_id = models.ForeignKey(SecurityMeta, on_delete=models.CASCADE)
    date = models.DateField()
    intangible_assets = models.DecimalField(max_digits=15, decimal_places=2)
    total_liab = models.DecimalField(max_digits=15, decimal_places=2)
    total_stockholder_equity = models.DecimalField(max_digits=15, decimal_places=2)
    other_current_liab = models.DecimalField(max_digits=15, decimal_places=2)
    total_assets = models.DecimalField(max_digits=15, decimal_places=2)
    common_stock = models.DecimalField(max_digits=15, decimal_places=2)
    other_current_assets = models.DecimalField(max_digits=15, decimal_places=2)
    retained_earnings = models.DecimalField(max_digits=15, decimal_places=2)
    other_liab = models.DecimalField(max_digits=15, decimal_places=2)
    good_will = models.DecimalField(max_digits=15, decimal_places=2)
    treasury_stock = models.DecimalField(max_digits=15, decimal_places=2)
    ...
    deferred_long_term_asset_charges = models.DecimalField(max_digits=15, decimal_places=2)
    short_long_term_debt = models.DecimalField(max_digits=15, decimal_places=2)
    other_stockholder_equity = models.DecimalField(max_digits=15, decimal_places=2)
    property_plant_equipment = models.DecimalField(max_digits=15, decimal_places=2)
    total_current_assets = models.DecimalField(max_digits=15, decimal_places=2)
    long_term_investments = models.DecimalField(max_digits=15, decimal_places=2)
    net_tangible_assets = models.DecimalField(max_digits=15, decimal_places=2)
    short_term_investments = models.DecimalField(max_digits=15, decimal_places=2)
    net_receivables = models.DecimalField(max_digits=15, decimal_places=2)
