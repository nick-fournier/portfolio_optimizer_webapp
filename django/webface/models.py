...
class Dividends(models.Model):
    security = models.ForeignKey(SecurityMeta, on_delete=models.CASCADE)
    date = models.DateField()
    dividends = models.DecimalField(max_digits=16, decimal_places=6)
...
class Scores(models.Model):
    ...
    PF_score= models.DecimalField(max_digits=16, default=None, null=True, decimal_places=6)
    ...
    cash = models.DecimalField(max_digits=16, default=None, null=True, decimal_places=6)
    ...
    delta_long_leverage_ratio = models.DecimalField(max_digits=16, default=None, null=True, decimal_places=6)
    delta_current_leverage_ratio = models.DecimalField(max_digits=16, default=None, null=True, decimal_places=6)
